...
VPCの作成
```bash
rake VPC:create_type01_vpc   # １つのアベイラビリティゾーンに１つのパブリックサブネットVPCを作成する
rake VPC:create_type02_vpc   # １つのアベイラビリティゾーンに２つのパブリックサブネットVPCを作成する
rake VPC:create_type03_vpc   # １つのアベイラビリティゾーンに１つのパブリックサブネットと１つのプライベートサブネットVPCを作成する
rake VPC:create_type04_vpc   # ２つのアベイラビリティゾーンに２つのプライベートサブネットVPCを作成する
rake VPC:create_type05_vpc   # ２つのアベイラビリティゾーンに２つのパブリックサブネットVPCを作成する
rake VPC:create_type06_vpc   # ２つのアベイラビリティゾーンに１つのパブリックサブネットと１つのプライベートサブネットVPCを作成する
rake VPC:create_type07_vpc   # ２つのアベイラビリティゾーンに２つのパブリックサブネットと２つのプライベートサブネットVPCを作成する
rake VPC:destroy_type01_vpc  # １つのアベイラビリティゾーンに１つのパブリックサブネットVPCを削除する
rake VPC:destroy_type02_vpc  # １つのアベイラビリティゾーンに２つのパブリックサブネットVPCを削除する
rake VPC:destroy_type03_vpc  # １つのアベイラビリティゾーンに１つのパブリックサブネットと１つのプライベートサブネットを削除する
rake VPC:destroy_type04_vpc  # ２つのアベイラビリティゾーンに２つのプライベートサブネットを削除する
rake VPC:destroy_type05_vpc  # ２つのアベイラビリティゾーンに２つのパブリックサブネットVPCを削除する
rake VPC:destroy_type06_vpc  # ２つのアベイラビリティゾーンに１つのパブリックサブネットと１つのプライベートサブネットVPCを削除する
rake VPC:destroy_type07_vpc  # ２つのアベイラビリティゾーンに２つのパブリックサブネットと２つのプライベートサブネットVPCを削除する
```
